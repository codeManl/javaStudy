package com.codemanl.config;//package com.codemanl.config;
//
...
// */
//@Configuration
//public class ItemWriterDemoJdbcWriter {
//    @Autowired
...
//
//    @Bean
//    public Job itemWriterJdbcWriterJob() {
//        return jobBuilderFactory.get("itemWriterJdbcWriterJob")
//                .start(step1())
//                .build();
//    }
//
